        ...
        {dash && (
          <div className="shrink-0 border-b px-4 md:px-6 py-3 overflow-x-auto" style={{ borderColor: "var(--border)" }}>
            <div className="flex gap-3 min-w-max">
              ...
              {/* Today's calendar */}
              <Link to="/calendar" className="shrink-0 w-52 rounded-lg border p-3 hover:border-[var(--border-hover)] transition-colors" style={{ background: "var(--bg-card)", borderColor: "var(--border)" }}>
        ...
        {activeConv && (
          <div className="shrink-0 border-t px-4 md:px-6 py-3" style={{ borderColor: "var(--border)" }}>
            <div className="max-w-3xl mx-auto flex gap-2">
              ...
              <button onClick={send} disabled={sending || uploading || !input.trim()} className="px-5 py-2.5 rounded-lg text-sm font-medium disabled:opacity-30" style={{ background: "var(--accent)", color: "#000" }}>Send</button>
            </div>
          </div>
        )}
      </div>
