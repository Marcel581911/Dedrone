...
export const hostCities: HostCity[] = [
  // ───────────────────────── NEW YORK / NEW JERSEY ─────────────────────────
  {
    ...
    tracker: [
      { account: 'NYPD Counter-Terrorism', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'Yes', shipmentStatus: 'Shipped', c2Deployment: 'Not Started', shippingAddress: 'NYPD Counter Terrorism, ATT: Lt. Jame Reilly, 2615 W 13 St Brooklyn NY', salesEngineer: 'Chris Helmerson', installDate: '', ae: 'Jackson Markey', owner: 'Cole Austin', notes: '3/28: Small legal adjustment for waiver. Expect signature Monday so we can ship before EOQ' },
      { account: 'Morris County DPS', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'N/A', fbiTraining: 'N/A', readyForDelivery: 'Yes', shipmentStatus: 'In Progress', c2Deployment: 'Not Started', shippingAddress: 'Morris County Dept of Law & Public Safety, 500 West Hanover Avenue, Morris Plains, NJ 07950', salesEngineer: 'Chris Helmerson', installDate: 'May 5th (pending equipment)', ae: 'Jackson Markey / Carlo Capano', owner: 'Cole Austin', notes: '3/28: Bulk shipments beginning Monday. Plan to deliver all equipment before May 1st' },
      { account: 'NY State Police', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Chris Helmerson', installDate: '', ae: 'Jackson Markey', owner: 'Cole Austin', notes: '3/20: Waiting on PO' },
      { account: 'MTA PD', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'N/A', fbiTraining: 'N/A', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Chris Helmerson', installDate: '', ae: 'Jackson Markey', owner: 'Cole Austin', notes: '3/20: Waiting on PO' },
      { account: 'MTA B&T', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'N/A', fbiTraining: 'N/A', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: 'Jackson Markey', owner: 'Cole Austin', notes: '3/20: Waiting on PO' },
      { account: 'NJ State Police', dealClosedWon: '-', poReceived: '-', waiverReceived: '-', fbiTraining: '-', readyForDelivery: '-', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: '', owner: '', notes: '' },
      { account: 'NJ Transit', dealClosedWon: '-', poReceived: '-', waiverReceived: '-', fbiTraining: '-', readyForDelivery: '-', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: '', owner: '', notes: '' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── LOS ANGELES ─────────────────────────
  {
    ...
    tracker: [
      { account: 'LAPD HQ', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: '-', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: '', ae: 'Travis Scott', owner: 'Cole Austin', notes: '3/17: Funding released, working through DLA. Likely to close by 3/27' },
      { account: 'Inglewood PD', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'Scheduled', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: '', ae: 'Clay Taylor', owner: 'Cole Austin', notes: '3/18: Submitting final quote to DLA. FBI CUSO scheduled' },
      { account: 'California Highway Patrol', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'No', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: '', ae: 'Tiffany Van De Berg', owner: 'Cole Austin', notes: '3/24: CHP waiting for CalOES to confirm final dollar amount' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── DALLAS ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Dallas PD FIFA', dealClosedWon: 'Yes', poReceived: 'No', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'Pending', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Evan Mabry', installDate: 'Pending', ae: 'Jayde Wilks / Parker Chapman', owner: 'Cole Austin', notes: '3/28: Have begun shipping OSP portion. Still waiting for DPD to receive FIFA grant funding. Waiting on internal waiver from CAO office' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── SAN FRANCISCO BAY AREA ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Santa Clara County', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: '-', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: '', ae: 'Travis Scott', owner: 'Cole Austin', notes: '3/28: Expecting a PO any hour now' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── MIAMI ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Miami-Dade Sheriff Office', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'March 23rd', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Alex Santos', installDate: '', ae: 'Jayde Wilks / Parker Chapman', owner: 'Soyeol Yoo', notes: '3/23: Wants to remove a fixed site originally scoped. Hoping to have PO in next 2 weeks' },
      { account: 'Miami PD', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'No', fbiTraining: 'Early May', readyForDelivery: 'Yes', shipmentStatus: 'Partially Shipped', c2Deployment: 'Not Started', shippingAddress: 'City of Miami PD, 400 NW 2nd Avenue, Miami, FL 33128, Attn: Lt Alex Gutierrez', salesEngineer: 'Alex Santos', installDate: 'May 5th', ae: 'Parker Chapman', owner: 'Cole Austin', notes: '3/20: PO received. Shipping non-mitigation ASAP. Mitigation ships May after FBI CUSO' },
      { account: 'Miami Beach PD', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'Waiting for opening', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Alex Santos', installDate: '', ae: 'Jack Brunk', owner: 'Cole Austin', notes: '3/18: Waiting on state grant agreement language' },
      { account: 'FL Dept of Law Enforcement (FDLE)', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'March 23rd', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Alex Santos', installDate: '', ae: 'Jack Brunk', owner: 'Cole Austin', notes: '3/18: Funds from Fed, state approval needed. Legislature battling over budget' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── ATLANTA ─────────────────────────
  {
    ...
    tracker: [
      { account: 'GA Bureau of Investigation', dealClosedWon: '-', poReceived: '-', waiverReceived: '-', fbiTraining: '-', readyForDelivery: '-', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: 'Nik Thompson', owner: 'Soyeol Yoo', notes: '3/12: GBI still finding funds, on hold' },
      { account: 'Atlanta PD', dealClosedWon: '-', poReceived: '-', waiverReceived: '-', fbiTraining: 'Scheduled', readyForDelivery: '-', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: 'Parker Chapman', owner: 'Cole Austin', notes: '3/23: Most likely pushing to April, going to council' },
      { account: 'Cobb County PD', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'No', fbiTraining: 'Scheduled', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: 'Sean Farren', owner: 'Cole Austin', notes: '3/28: Approved on agenda 3/24. Will now have to go back to legal. Low upside to come in before EOQ' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── PHILADELPHIA ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Philadelphia PD', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'Yes', fbiTraining: 'Yes', readyForDelivery: 'Yes', shipmentStatus: 'Shipped', c2Deployment: 'Not Started', shippingAddress: 'Delaware Valley Intelligence Center, 2810 S 20th St, Philadelphia, PA 19145, BLDG #6 Attn: SGT. Darnell Jessie', salesEngineer: 'Chris Helmerson', installDate: '', ae: 'Jackson Markey / Sean Farren', owner: 'Cole Austin', notes: '3/28: Equipment shipped' },
      { account: 'Delaware County OES', dealClosedWon: 'No', poReceived: 'No', waiverReceived: 'N/A', fbiTraining: 'N/A', readyForDelivery: 'No', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: '', ae: 'Travis Scott', owner: 'Cole Austin', notes: '3/20: Received $1.4M in cUAS funding. Discussing 10 Portables for county-wide coverage' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── SEATTLE ─────────────────────────
  {
    ...
    tracker: [
      { account: 'King County', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'Yes', shipmentStatus: 'Pending', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: 'Mid / Late May', ae: 'Travis Scott', owner: 'Cole Austin', notes: '3/20: PO received. Will begin shipping in April' },
      { account: 'Washington State Police', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'Pending', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: '', installDate: 'Mid / Late May', ae: 'Travis Scott', owner: 'Cole Austin', notes: '3/25: PO received, in Huntsville now for FBI training. Will begin shipping in April' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── BOSTON ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Mass State Police', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'Pending', fbiTraining: 'Yes', readyForDelivery: 'Pending', shipmentStatus: '-', c2Deployment: 'Not Started', shippingAddress: 'Attn: Lt. Brian Mahoney, MA State Police HQ, 470 Worcester Road, Framingham MA 01702', salesEngineer: '', installDate: '', ae: 'Jackson Markey', owner: 'Cole Austin', notes: '3/28: PO received. Working on signed waiver and scheduling deployment meeting' },
    ],
    supportTeam: [],
  },
  ...
  // ───────────────────────── VANCOUVER ─────────────────────────
  {
    ...
    tracker: [
      { account: 'Vancouver PD', dealClosedWon: 'Yes', poReceived: 'Yes', waiverReceived: 'N/A', fbiTraining: 'N/A', readyForDelivery: 'Pending', shipmentStatus: 'Pending', c2Deployment: 'Not Started', shippingAddress: '', salesEngineer: 'Vince Hill / Derek Bushman', installDate: '', ae: 'Kam Dhanoya', owner: 'Soyeol Yoo', notes: '3/24: Reached out to customer for ship date confirmation' },
    ],
    supportTeam: [],
  },
